...
insert into Astronot (ad,soyad,calistigi_sirket_ad,gezegen_ad) values ('Hüseyin','Cabbar','NASA','Mars')
insert into Astronot (ad,soyad,calistigi_sirket_ad,gezegen_ad) values ('Abdulkerim','Kýrkayak','TESLA','Venus')
